...
export const createStudentClassRequest = (studentClassRequest) => async (dispatch) => {
    try {
        const res = await axios.post('/students-Class-Request', studentClassRequest);
        dispatch({
...
export const deleteStudentClassRequest = (id) => async (dispatch) => {
    try {
        await axios.delete(`/students-Class-Request/${id}`);
        dispatch({
